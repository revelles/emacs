...
Output the Markdown file as LaTeX." t nil)
...
Render markdown and copy as RTF." t nil)

(autoload 'markdown-copy-paste-html "markdown-mode+" "\
Process file with multimarkdown, copy it to the clipboard, and paste in safari's selected textarea." t nil)
